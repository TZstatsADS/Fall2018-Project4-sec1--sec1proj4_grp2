...
+ Project summary: In this project, we created an OCR post-processing procedure to enhance Tesseract OCR output.     (For details, explanations and ideas, please download doc/main.nb.html to view.)
